...
<div class="col-md-3 col-md-offset-1">
    <div class="panel panel-default">
        ...
        <div class="panel-body text-center">
            <img src="{{url('images/users-avatar/'.$user->id.'/250')}}" class="img-responsive thumbnail"/>
            ...
            <p>{{ $user->email }}</p>
            <p><a href="{{url('/users/'.$user->id.'/friends')}}">Zobacz znajomych </a><span class="label label-primary">{{$user->friends()->count()}}</span> </p>
